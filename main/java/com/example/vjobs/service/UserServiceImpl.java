...
import com.example.vjobs.model.Role;
import com.example.vjobs.model.User;
import com.example.vjobs.repository.UserRepository;
...
public class UserServiceImpl implements UserService{
	...
	public User save(UserRegistrationDto registrationDto) {
		User user = new User(registrationDto.getUserName(),registrationDto.getEmail(),
				passwordEncoder.encode(registrationDto.getPassword()),Arrays.asList(new Role("Student")));
